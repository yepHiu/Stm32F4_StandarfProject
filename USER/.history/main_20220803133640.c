...
//      (OS_ERR *)&err);
  ...
  OSTaskCreate(
      (OS_TCB *)&UART1_TaskTCB,      //任务控制块
      (CPU_CHAR *)"UART1_task",      //任务名字
      (OS_TASK_PTR)UART1_task,       //任务函数
      (void *)0,                    //传递给任务的参数
      (OS_PRIO)UART1_TASK_PRIO,      //任务优先级别
      (CPU_STK *)&UART1_TASK_STK[0], //栈基地址
